...
<body>
	...
	<div class="container" id="#typography">
    	...
    	<div class="card soft" id="paragraphs">
    		...
    		<p>Lorem ipsum dolor, sit amet consectetur, adipisicing elit. Quia explicabo quod alias illum fuga aliquid voluptate saepe architecto, maiores iste harum cumque nihil, vitae quidem error amet sapiente distinctio vel?</p>
    ...
    <div class="container" id="viewwindow">
        ...
        <div class="view-window" style="background-image: url(./img/vintage.jpeg);">
